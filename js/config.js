 ...
 * Agora, ele exporta as configurações como um módulo ES6 para serem importadas
 * diretamente onde forem necessárias, em vez de depender de um objeto global.
 */

/**
 * Lista de brindes padrão disponíveis na loja.
 * Estes são carregados na primeira vez que o jogo é iniciado
 * ou quando não há dados de brindes no Firestore.
 * - id: Identificador único (será ignorado pelo Firestore, que gera o seu próprio).
 ...
 * - slot: Em qual camada do avatar o item é equipado ('rosto', 'cabeca', 'fundo', 'base', 'companheiro').
 */
export const BRINDES_PADRAO = [
    // Tier 1 - Básico
