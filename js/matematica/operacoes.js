...
/**
 * Gera uma pergunta de operação básica com base na trilha e idade do jogador.
 ...
 */
export function gerarProblemaOperacoes(trilha, idade = 8) { // idade padrão de 8 anos
